...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{img/mockup-home.png}
  \caption{Diseño final — Página de Inicio: hero con logo de marca y tagline \textit{«Arte que cobra vida»} (izquierda), obra destacada de la artista (derecha), accesos directos al portafolio y servicios.}
  \label{fig:mockup-home}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{img/mockup-portafolio.png}
  \caption{Diseño final — Portafolio: galería filtrable por categoría (Ilustración, Personajes, Modelado 3D, Storyboard) con las obras reales de Lulú Tapia.}
