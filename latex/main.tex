...
\begin{figure}[H]
  \centering
  \IfFileExists{../pencil/mockup-home.png}{%
    \includegraphics[width=0.82\textwidth]{../pencil/mockup-home.png}%
  }{%
    \fbox{\parbox{0.82\textwidth}{\centering\vspace{1.8cm}%
      \textit{[Exportar frame «Home» desde Pencil y guardar como \texttt{pencil/mockup-home.png}]}%
      \vspace{1.8cm}}}%
  }
  \caption{Mockup de alta fidelidad — Página de Inicio (\textit{Home}): hero con logo, tagline y galería de trabajos destacados.}
  \label{fig:mockup-home}
\end{figure}

\begin{figure}[H]
  \centering
  \IfFileExists{../pencil/mockup-portafolio.png}{%
    \includegraphics[width=0.82\textwidth]{../pencil/mockup-portafolio.png}%
  }{%
    \fbox{\parbox{0.82\textwidth}{\centering\vspace{1.8cm}%
      \textit{[Exportar frame «Portafolio» desde Pencil y guardar como \texttt{pencil/mockup-portafolio.png}]}%
      \vspace{1.8cm}}}%
  }
  \caption{Mockup de alta fidelidad — Portafolio: galería filtrable por categoría con vista previa de obras.}
